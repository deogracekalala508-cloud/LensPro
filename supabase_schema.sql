-- LensPro Supabase Database Schema
...
CREATE TABLE IF NOT EXISTS public.photos (
    ...
    thumbnail_url TEXT,
    before_image_url TEXT, -- For before/after comparisons
...
-- 5. GALLERIES TABLE (Client Event Delivery)
...
-- Create buckets: 'portfolio-photos', 'client-galleries', 'avatars'
